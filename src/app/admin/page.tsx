  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 md:p-10 font-mono text-sm">
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center mb-8 bg-white p-4 border-2 border-black shadow-hard">
        ...
        <form action={logout}>
          <button className="bg-red-500 text-white px-4 py-2 font-bold uppercase hover:bg-red-600 transition-colors border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px]">
            Logout
          </button>
        </form>
      </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <form action={addProject} className="flex flex-col gap-4">
              <div>
                ...
                <input
                  ...
                  type="text"
                  required
                  className="w-full p-2 border-2 border-gray-300 focus:border-black focus:outline-none bg-gray-50 font-bold text-black"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={3}
                  className="w-full p-2 border-2 border-gray-300 focus:border-black focus:outline-none bg-gray-50 text-black"
              ...
              <div>
                ...
                <input
                  ...
                  type="file"
                  accept="image/*"
                  className="w-full text-xs file:mr-2 file:py-1 file:px-2 file:border-2 file:border-black file:text-[10px] file:font-bold file:uppercase file:bg-[#0066F7] file:text-white hover:file:bg-[#0066F7] cursor-pointer text-black"
                />
              </div>
        ...
        <div className="lg:col-span-8">
          <div className="bg-white p-6 border-2 border-black shadow-hard min-h-[500px]">
            <h2 className="text-xl font-bold mb-6 uppercase border-b-2 border-black pb-2 text-black">
            ...
            {projects.length === 0 ? (
              ...
              <div className="space-y-4">
                {projects.map((project) => (
                  <div
                    key={project.id}
                    className="flex flex-col md:flex-row gap-4 border-2 border-gray-200 p-4 hover:border-black transition-colors group bg-gray-50 text-black"
                  >
                    {/* Thumbnail Image */}
